(function ($) {
    ...
    ───────────────────────────────────────────── */
    var heroSection = document.querySelector('.header-carousel');
    if (heroSection) {
        ...
        function drawParticles() {
            ...
            particles.forEach(function (p) {
                ...
                ctx.fillStyle = 'rgba(208,117,23,' + p.o + ')';
                ctx.fill();
                p.x += p.dx;
                p.y += p.dy;
            ...
            for (var a = 0; a < particles.length; a++) {
                for (var b = a + 1; b < particles.length; b++) {
                    ...
                    if (dist < 110) {
                        ctx.beginPath();
                        ctx.strokeStyle = 'rgba(208,117,23,' + (0.1 * (1 - dist / 110)) + ')';
                        ctx.lineWidth = 0.5;
